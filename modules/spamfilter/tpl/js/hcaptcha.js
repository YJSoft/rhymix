...
function hCaptchaCallback() {
    var recaptcha_config = $("#hcaptcha-config");
    var recaptcha_instances = $(".h-captcha");
    ...
    if (recaptcha_instances.length === 0) {
        ...
        autoinsert_candidates.each(function() {
            var new_instance = $('<div class="h-captcha"></div>');
            new_instance.attr("id", "hcaptcha-instance-" + recaptcha_instance_id++);
    ...
    recaptcha_instances.each(function() {
        ...
        hcaptcha.render(instance.attr("id"), {
