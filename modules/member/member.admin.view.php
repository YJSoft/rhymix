...
class memberAdminView extends member
{
	...
	public function dispMemberAdminSignUpConfig()
	{
		...
		$option->primary_key_name = 'agreement_srl';
		...
		Context::set('agreement_editor', $editor);
		
		$option->primary_key_name = 'privacy_srl';
		$option->content_key_name = 'privacy';
		$editor = $oEditorModel->getEditor(0, $option);
		Context::set('privacy_editor', $editor);
